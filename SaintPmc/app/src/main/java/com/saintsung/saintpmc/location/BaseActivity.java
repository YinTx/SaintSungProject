...
import com.saintsung.saintpmc.location.util.ErrorInfo;
import com.saintsung.saintpmc.location.util.TTSController;
...
//    protected TTSController mTtsManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double[] Point=intent.getDoubleArrayExtra("Point");
